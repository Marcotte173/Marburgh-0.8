...
public class Room
{
    ...
    {
            new Room("Captive townsfolk",new string[]{"A makeshift prison cell","You see an old prison. Thank goodness the people escaped" },0,new Event[] { Event.RandomList[5] },null),
    ...
    {
            new Room("Boss Room", new string[]{$"A secret Lair!","A secret Lair!"},0,new Event[] { Event.CastleStaticList[0] },null),
            new Room("Servant Mini Boss",new string[]{"A makeshift prison cell","You see an old prison. Thank goodness the people escaped" },0,new Event[] { Event.CastleStaticList[1] },null),
            new Room("Kitchen Mini Boss",new string[]{"A room with a treasure chest!","You see an old empty chest" },0,new Event[] { Event.CastleStaticList[2] },null),
            new Room("To Servants",new string[]{"A room with a small altar"," You see a broken altar" },0,new Event[] { Event.CastleStaticList[3] },null),
            new Room("To Kitchen",new string[]{"An elite Orc!","You see an empty room with a dead ogre in it" },0,new Event[] { Event.CastleStaticList[4] },null),
            new Room("To Bedrooms",new string[]{"An elite Orc!","You see an empty room with a dead ogre in it" },0,new Event[] { Event.CastleStaticList[5] },null)
    };    
