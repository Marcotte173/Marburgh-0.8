...
{    
    class Program
    {
        ...
        public static Dungeon d = new Dungeon("", 1, "", 0, 0, Room.StarterRoomList, Room.StarterRoomList, Room.StarterRoomList, Boss.BossList[0], false,  1, false, Shell.StarterDungeonShell,0);
        //STARTS GAME
