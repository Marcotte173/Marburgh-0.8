...
class Create
{
    ...
    public static string[] mageAttacks = new string[] { "["+ Colour.SPECIAL + "3" +Colour.RESET+ "]" + Colour.SPECIAL+ "Fireblast" + Colour.RESET, "[4]Arcane Missiles", "[5]Arcane Explosion", "[6]Ice Bolt" };
    public static string[] rogueAttacks = new string[] { "["+ Colour.SPECIAL + "3" + Colour.RESET + "]" + Colour.SPECIAL + "Stun" + Colour.RESET, "[4]Backstab", "[5]Stun", "[6]Vanish" };
    public static string[] warriorAttacks = new string[] { "["+ Colour.SPECIAL + "3" + Colour.RESET + "]" + Colour.SPECIAL + "Rend" + Colour.RESET, "[4]Scream" , "[5]Smash", "[6]Enrage" };
    public static pClass Warrior = new pClass("Warrior", 20, 2, 0, 0, 0);
    public static pClass Rogue = new pClass("Rogue", 16, 3, 0, 0, 0);
    public static pClass Mage = new pClass("Mage", 16, 2, 2, 2, 0);
