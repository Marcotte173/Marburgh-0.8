...
public class Monster: Creature
{
    ...
    {
            new Monster("Slime",  pClass.MonsterClassList[0], 5, 10, 0, 0, Drop.drop[3]),
            new Monster("Goblin",  pClass.MonsterClassList[1], 5, 20, 0, 0, Drop.drop[1]),
            new Monster("Kobold",  pClass.MonsterClassList[2], 5, 20, 0, 0, Drop.drop[2]),
    };

    public static Monster[] castleBestiary = new Monster[]
    {
        new Monster("Orc",  pClass.MonsterClassList[3], 12, 85, 0, 0, Drop.BossDrop[0]),
    };
